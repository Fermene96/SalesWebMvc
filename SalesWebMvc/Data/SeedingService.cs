...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Brown", "maria@gmail.com", new DateTime(1988, 6, 11), 3500.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", new DateTime(1991, 6, 4), 2200.0, d1);
            Seller s4 = new Seller(4, "Marta Red", "martha@gmail.com", new DateTime(1996, 1, 1), 3000.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(1998, 3, 26), 4000.0, d3);
            Seller s6 = new Seller(6, "Alex Pink", "bob@gmail.com", new DateTime(1980, 9, 24), 3000.0, d2);
